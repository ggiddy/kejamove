						...
						<div id="package" class="tab-pane active">
							<form class="form-horizontal gpg-generator-form" method="POST" action="<?php echo base_url().'index.php/gen/model/'?>">
								...
								<div class="form-content">
									...
									<div class="form-group">
										<label class="control-label col-lg-2">Model API Class</label>
										<div class="controls col-lg-8">
											<input type="text" class="form-control" name="model_api_class" placeholder="base model class api class"/>
										</div>
									</div>
									<div class="form-group">
